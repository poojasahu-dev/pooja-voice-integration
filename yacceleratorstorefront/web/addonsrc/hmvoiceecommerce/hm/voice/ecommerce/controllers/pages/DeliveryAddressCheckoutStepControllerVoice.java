...
/**
 * @author PoojacheckoutSteps.tag
 *
 */
@Controller
@RequestMapping(value = "/checkout/multi/delivery-address-voice")
public class DeliveryAddressCheckoutStepControllerVoice extends AbstractCheckoutStepController
{
	...
	String deliveryAddressCheckoutPage = VIEW_PAGE_PREFIX + "pages/checkout/multi/addEditDeliveryAddressPageVoice";
	...
	public String enterStep(final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		return deliveryAddressCheckoutPage;
	}
