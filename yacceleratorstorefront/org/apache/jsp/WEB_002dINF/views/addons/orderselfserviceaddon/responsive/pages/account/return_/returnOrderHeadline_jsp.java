 ...
 * Generated at: 2020-06-01 06:20:39 UTC
...
public final class returnOrderHeadline_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  private boolean _jspx_meth_spring_005fhtmlEscape_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/addons/orderselfserviceaddon/responsive/pages/account/return/returnOrderHeadline.jsp(6,0) name = defaultHtmlEscape type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/addons/orderselfserviceaddon/responsive/pages/account/return/returnOrderHeadline.jsp(8,0) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005furl_005f0.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("/my-account/order/${fn:escapeXml(orderData.code)}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, _jspx_fnmap_0));
      // /WEB-INF/views/addons/orderselfserviceaddon/responsive/pages/account/return/returnOrderHeadline.jsp(8,0) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005furl_005f0.setVar("orderDetailsUrl");
      // /WEB-INF/views/addons/orderselfserviceaddon/responsive/pages/account/return/returnOrderHeadline.jsp(8,0) name = htmlEscape type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_common_005fheadline_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/addons/orderselfserviceaddon/responsive/pages/account/return/returnOrderHeadline.jsp(9,0) name = url type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = java.lang.String deferredMethod = false methodSignature = null
      _jspx_th_common_005fheadline_005f0.setUrl((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${orderDetailsUrl}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      // /WEB-INF/views/addons/orderselfserviceaddon/responsive/pages/account/return/returnOrderHeadline.jsp(9,0) name = labelKey type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = java.lang.String deferredMethod = false methodSignature = null
      _jspx_th_common_005fheadline_005f0.setLabelKey("text.account.return.order.title");
      // /WEB-INF/views/addons/orderselfserviceaddon/responsive/pages/account/return/returnOrderHeadline.jsp(9,0) name = labelArguments type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = java.lang.String deferredMethod = false methodSignature = null
