...
@Controller
@RequestMapping(value = "/checkout/multi/payment-method-voice")
public class PaymentMethodCheckoutStepControllerVoice extends AbstractCheckoutStepController
{
	...
	String paymentMethodPageVoice = VIEW_PAGE_PREFIX + "pages/checkout/multi/silentOrderPostPageVoice";
