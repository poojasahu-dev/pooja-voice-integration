    ...
    <div class="container-lg col-md-6">
        <div class="account-section-content">
            <div class="account-section-form">
                <address:addressFormSelectorVoice supportedCountries="${countries}" regions="${regions}" cancelUrl="/my-account-voice/address-book-voice" addressBook="true" />
            </div>
        </div>
    </div>
</div>
<address:suggestedAddressesVoice selectedAddressUrl="/my-account-voice/select-suggested-address" />
