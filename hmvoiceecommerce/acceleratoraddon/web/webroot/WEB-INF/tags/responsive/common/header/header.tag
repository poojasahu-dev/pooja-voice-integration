			...
			<div class="row desktop__nav">
				...
				<div class="nav__right col-xs-6 col-xs-6 hidden-xs">
					<ul class="nav__links nav__links--shop_info">
					     <li>
                            <a href="#" class="btn" id="stopVoice" onclick="stop()" style="display:none;margin-top:15px; margin-right:15px;" >
								<i class="fa fa-microphone fa_custom fa-2x"></i>
						   </a>
						</li>
						<li>
                             <a href="#" class="btn" id="startVoice" onclick="start()" style="margin-top:15px; margin-right:15px;" >
								<i class="fa fa-microphone-slash fa_custom fa-2x"></i>
						   </a>
						</li> 
