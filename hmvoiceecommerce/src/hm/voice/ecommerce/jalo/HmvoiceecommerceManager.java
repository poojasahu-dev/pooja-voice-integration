...
/**
 * This is the extension manager of the Hmvoiceecommerce extension.
 */
public class HmvoiceecommerceManager extends GeneratedHmvoiceecommerceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HmvoiceecommerceManager.class.getName());
	 ...
	 */
	public static HmvoiceecommerceManager getInstance()
	{
		return (HmvoiceecommerceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HmvoiceecommerceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HmvoiceecommerceManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HmvoiceecommerceManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HmvoiceecommerceManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HmvoiceecommerceManager called, current tenant: " + getTenant().getTenantID());
		}
	}
